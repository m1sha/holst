...
// import { Arc, ArcTo, BezierCurveTo, Circle, Ellipse, LineTo, MoveTo, QuadraticCurveTo, Rect, RoundRect } from '../types/path2d-element'
...
// export class BezierCurveToDecorator {
//   private bezierCurveTo: BezierCurveTo
//   private mutable: Mutable

//   constructor (bezierCurveTo: BezierCurveTo, mutable: Mutable) {
//     this.bezierCurveTo = bezierCurveTo
//     this.mutable = mutable
//   }

//   get x () { return this.bezierCurveTo.x }
//   set x (value: number) { this.bezierCurveTo.x = value; this.mutable.setModified() }

//   get y () { return this.bezierCurveTo.y }
//   set y (value: number) { this.bezierCurveTo.y = value; this.mutable.setModified() }

//   get cp1x () { return this.bezierCurveTo.cp1x }
//   set cp1x (value: number) { this.bezierCurveTo.cp1x = value; this.mutable.setModified() }

//   get cp1y () { return this.bezierCurveTo.cp1y }
//   set cp1y (value: number) { this.bezierCurveTo.cp1y = value; this.mutable.setModified() }

//   get cp2x () { return this.bezierCurveTo.cp2x }
//   set cp2x (value: number) { this.bezierCurveTo.cp2x = value; this.mutable.setModified() }

//   get cp2y () { return this.bezierCurveTo.cp2y }
//   set cp2y (value: number) { this.bezierCurveTo.cp2y = value; this.mutable.setModified() }
// }

// export class QuadraticCurveToDecorator {
//   private quadraticCurveTo: QuadraticCurveTo
//   private mutable: Mutable

//   constructor (bezierCurveTo: QuadraticCurveTo, mutable: Mutable) {
//     this.quadraticCurveTo = bezierCurveTo
//     this.mutable = mutable
//   }

//   get x () { return this.quadraticCurveTo.x }
//   set x (value: number) { this.quadraticCurveTo.x = value; this.mutable.setModified() }

//   get y () { return this.quadraticCurveTo.y }
//   set y (value: number) { this.quadraticCurveTo.y = value; this.mutable.setModified() }

//   get cpx () { return this.quadraticCurveTo.cpx }
//   set cpx (value: number) { this.quadraticCurveTo.cpx = value; this.mutable.setModified() }

//   get cpy () { return this.quadraticCurveTo.cpy }
//   set cpy (value: number) { this.quadraticCurveTo.cpy = value; this.mutable.setModified() }
// }
